...
#Load in fragments that were found in earlier calculation
def load_23_mode_params_new(mol, nmodes, nmodals, loc=True):
    '''
    Parameters
    ----------
    params : array of fragment parameters
    ...
    if loc == True:
      ...
      with open(rf"VSCF_basis_frags/{mol}_VSCFfragments_{str(nmodals)}M_3MC.out", 'rb') as f:
          params, norms = pickle.load(f)
...
#Load in fragments that were found in earlier calculation
def load_2_mode_params_new(mol, nmodes, nmodals, loc=True):
    '''
    Parameters
    ----------
    params : array of fragment parameters
    ...
    if loc == True:
      ...
      with open(rf"VSCF_basis_frags/{mol}_VSCFfragments_{str(nmodals)}M_2MC.out", 'rb') as f:
          params, norms = pickle.load(f)
